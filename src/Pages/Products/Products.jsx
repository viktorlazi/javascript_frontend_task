      ...
      <DisplayList> 
        {
          ProductsService.processedList.map((e)=>{
            return <ListElement props={ProductsStore.getElementById(e)} editElement={(edited, id)=>{ProductsService.editElement(edited, id)}} removeElement={(x)=>ProductsService.removeElement(x)}/>
          })
        }        
      </DisplayList>
